...
export const PRICES_DATA: Record<string, Record<string, { price: number; originalPrice?: number; isOnSale: boolean }>> = {
  ...
  "Alpsko mleko 3.5%": {
    ...
    "Lidl": { price: 1.19, isOnSale: false },
    "Hofer": { price: 1.15, isOnSale: false },
    "Jager": { price: 1.39, isOnSale: false },
  },
  "Jogurt Activia naravni": {
    "Spar": { price: 0.89, isOnSale: false },
    "Mercator": { price: 0.95, isOnSale: false },
    "Tus": { price: 0.85, isOnSale: false },
    "Lidl": { price: 0.79, isOnSale: false },
    "Hofer": { price: 0.75, originalPrice: 0.89, isOnSale: true },
    "Jager": { price: 0.99, isOnSale: false },
  },
  "Sir Edamec": {
    "Spar": { price: 2.49, isOnSale: false },
    "Mercator": { price: 2.59, originalPrice: 2.99, isOnSale: true },
    "Tus": { price: 2.55, isOnSale: false },
    "Lidl": { price: 2.29, isOnSale: false },
    "Hofer": { price: 2.19, isOnSale: false },
    "Jager": { price: 2.79, isOnSale: false },
  },
  "Maslo Ljubljanske mlekarne": {
    "Spar": { price: 2.99, isOnSale: false },
    "Mercator": { price: 3.15, isOnSale: false },
    "Tus": { price: 2.89, isOnSale: false },
    "Lidl": { price: 2.79, isOnSale: false },
    "Hofer": { price: 2.69, originalPrice: 2.99, isOnSale: true },
    "Jager": { price: 3.29, isOnSale: false },
  },
  "Skuta": {
    "Spar": { price: 1.79, isOnSale: false },
    "Mercator": { price: 1.89, isOnSale: false },
    "Tus": { price: 1.75, isOnSale: false },
    "Lidl": { price: 1.59, isOnSale: false },
    "Hofer": { price: 1.55, isOnSale: false },
    "Jager": { price: 1.99, isOnSale: false },
  },
  ...
  "Coca-Cola": {
    ...
    "Lidl": { price: 1.69, isOnSale: false },
    "Hofer": { price: 1.65, isOnSale: false },
    "Jager": { price: 2.09, isOnSale: false },
  },
  "Radenska Classic": {
    "Spar": { price: 0.99, isOnSale: false },
    "Mercator": { price: 1.05, isOnSale: false },
    "Tus": { price: 0.95, isOnSale: false },
    "Lidl": { price: 0.89, isOnSale: false },
    "Hofer": { price: 0.85, isOnSale: false },
    "Jager": { price: 1.15, isOnSale: false },
  },
  "Pomarancni sok Fructal": {
    ...
    "Lidl": { price: 2.19, isOnSale: false },
    "Hofer": { price: 2.09, isOnSale: false },
    "Jager": { price: 2.59, isOnSale: false },
  },
  "Pivo Union": {
    "Spar": { price: 1.19, isOnSale: false },
    "Mercator": { price: 1.25, isOnSale: false },
    "Tus": { price: 1.15, isOnSale: false },
    "Lidl": { price: 1.09, isOnSale: false },
    "Hofer": { price: 0.99, originalPrice: 1.19, isOnSale: true },
    "Jager": { price: 1.35, isOnSale: false },
  },
  "Voda Zala": {
    "Spar": { price: 0.49, isOnSale: false },
    "Mercator": { price: 0.55, isOnSale: false },
    "Tus": { price: 0.45, isOnSale: false },
    "Lidl": { price: 0.39, isOnSale: false },
    "Hofer": { price: 0.35, isOnSale: false },
    "Jager": { price: 0.59, isOnSale: false },
  },
  ...
  "Piscancja prsa": {
    ...
    "Lidl": { price: 7.99, isOnSale: false },
    "Hofer": { price: 7.49, isOnSale: false },
    "Jager": { price: 9.99, isOnSale: false },
  },
  "Mleto mesano meso": {
    "Spar": { price: 4.49, isOnSale: false },
    "Mercator": { price: 4.79, isOnSale: false },
    "Tus": { price: 4.39, isOnSale: false },
    "Lidl": { price: 3.99, isOnSale: false },
    "Hofer": { price: 3.79, originalPrice: 4.29, isOnSale: true },
    "Jager": { price: 4.99, isOnSale: false },
  },
  "Kranjska klobasa": {
    "Spar": { price: 3.99, originalPrice: 4.49, isOnSale: true },
    "Mercator": { price: 4.29, isOnSale: false },
    "Tus": { price: 4.15, isOnSale: false },
    "Lidl": { price: 3.79, isOnSale: false },
    "Hofer": { price: 3.59, isOnSale: false },
    "Jager": { price: 4.49, isOnSale: false },
  },
  "Prsut": {
    "Spar": { price: 2.99, isOnSale: false },
    "Mercator": { price: 3.19, isOnSale: false },
    "Tus": { price: 2.89, isOnSale: false },
    "Lidl": { price: 2.69, isOnSale: false },
    "Hofer": { price: 2.49, isOnSale: false },
    "Jager": { price: 3.49, isOnSale: false },
  },
  "Svinjski zrezki": {
    "Spar": { price: 5.99, isOnSale: false },
    "Mercator": { price: 6.29, originalPrice: 6.99, isOnSale: true },
    "Tus": { price: 5.89, isOnSale: false },
    "Lidl": { price: 5.49, isOnSale: false },
    "Hofer": { price: 5.29, isOnSale: false },
    "Jager": { price: 6.49, isOnSale: false },
  },
  ...
  "Banane": {
    ...
    "Lidl": { price: 1.29, isOnSale: false },
    "Hofer": { price: 1.19, originalPrice: 1.39, isOnSale: true },
    "Jager": { price: 1.69, isOnSale: false },
  },
  "Jabolka": {
    "Spar": { price: 1.99, originalPrice: 2.29, isOnSale: true },
    "Mercator": { price: 2.19, isOnSale: false },
    "Tus": { price: 2.09, isOnSale: false },
    "Lidl": { price: 1.79, isOnSale: false },
    "Hofer": { price: 1.69, isOnSale: false },
    "Jager": { price: 2.29, isOnSale: false },
  },
  "Paradiznik": {
    "Spar": { price: 2.49, isOnSale: false },
    ...
    "Lidl": { price: 2.19, isOnSale: false },
    "Hofer": { price: 1.99, isOnSale: false },
    "Jager": { price: 2.89, isOnSale: false },
  },
  "Krompir": {
    "Spar": { price: 1.79, isOnSale: false },
    "Mercator": { price: 1.89, isOnSale: false },
    "Tus": { price: 1.69, isOnSale: false },
    "Lidl": { price: 1.49, isOnSale: false },
    "Hofer": { price: 1.39, isOnSale: false },
    "Jager": { price: 1.99, isOnSale: false },
  },
  "Solata": {
    "Spar": { price: 0.99, isOnSale: false },
    ...
    "Tus": { price: 0.95, isOnSale: false },
    "Lidl": { price: 0.89, isOnSale: false },
    "Hofer": { price: 0.79, isOnSale: false },
    "Jager": { price: 1.19, isOnSale: false },
  },
  ...
  "Beli kruh": {
    ...
    "Lidl": { price: 1.09, isOnSale: false },
    "Hofer": { price: 0.99, isOnSale: false },
    "Jager": { price: 1.49, isOnSale: false },
  },
  "Polnozrnati kruh": {
    ...
    "Lidl": { price: 1.59, isOnSale: false },
    "Hofer": { price: 1.49, isOnSale: false },
    "Jager": { price: 2.09, isOnSale: false },
  },
  "zemlje": {
    "Spar": { price: 1.49, isOnSale: false },
  ...
  "Rogljicki": {
    ...
    "Lidl": { price: 1.69, isOnSale: false },
    "Hofer": { price: 1.59, isOnSale: false },
    "Jager": { price: 2.29, isOnSale: false },
  },
  ...
  "Jajca M": {
    ...
    "Lidl": { price: 2.69, isOnSale: false },
    "Hofer": { price: 2.49, isOnSale: false },
    "Jager": { price: 3.39, isOnSale: false },
  },
  "Moka tip 500": {
    "Spar": { price: 0.99, isOnSale: false },
    ...
    "Tus": { price: 0.95, isOnSale: false },
    "Lidl": { price: 0.79, isOnSale: false },
    "Hofer": { price: 0.75, isOnSale: false },
    "Jager": { price: 1.19, isOnSale: false },
  },
  "Sladkor": {
  ...
  "Olje soncnicno": {
    ...
    "Lidl": { price: 2.19, isOnSale: false },
    "Hofer": { price: 1.99, originalPrice: 2.29, isOnSale: true },
    "Jager": { price: 2.79, isOnSale: false },
  },
  "Riz": {
    "Spar": { price: 1.79, isOnSale: false },
  ...
  "Testenine spageti": {
    ...
    "Tus": { price: 1.25, isOnSale: false },
    "Lidl": { price: 0.99, isOnSale: false },
    "Hofer": { price: 0.89, isOnSale: false },
    "Jager": { price: 1.49, isOnSale: false },
  },
  ...
  "cokolada Milka": {
    ...
    "Lidl": { price: 1.29, isOnSale: false },
    "Hofer": { price: 1.19, isOnSale: false },
    "Jager": { price: 1.69, isOnSale: false },
  },
  "Keksi Petit Beurre": {
    "Spar": { price: 1.79, isOnSale: false },
    ...
    "Tus": { price: 1.75, isOnSale: false },
    "Lidl": { price: 1.49, isOnSale: false },
    "Hofer": { price: 1.39, originalPrice: 1.59, isOnSale: true },
    "Jager": { price: 1.99, isOnSale: false },
  },
  ...
  "Pralni prasek Persil": {
    ...
    "Lidl": { price: 11.99, isOnSale: false },
    "Hofer": { price: 10.99, isOnSale: false },
    "Jager": { price: 14.49, isOnSale: false },
  },
  "Detergent za posodo Jar": {
    "Spar": { price: 2.99, isOnSale: false },
    "Mercator": { price: 3.19, isOnSale: false },
    "Tus": { price: 2.89, isOnSale: false },
    "Lidl": { price: 2.49, originalPrice: 2.89, isOnSale: true },
    "Hofer": { price: 2.39, isOnSale: false },
    "Jager": { price: 3.39, isOnSale: false },
  },
  "cistilo za WC Domestos": {
    ...
    "Lidl": { price: 2.49, isOnSale: false },
    "Hofer": { price: 2.29, isOnSale: false },
    "Jager": { price: 3.19, isOnSale: false },
  },
  ...
  "sampon Head & Shoulders": {
    ...
    "Tus": { price: 5.89, isOnSale: false },
    "Lidl": { price: 5.49, isOnSale: false },
    "Hofer": { price: 4.99, isOnSale: false },
    "Jager": { price: 6.49, isOnSale: false },
  },
  "Toaletni papir Paloma": {
    ...
    "Lidl": { price: 4.49, originalPrice: 4.99, isOnSale: true },
    "Hofer": { price: 3.99, isOnSale: false },
    "Jager": { price: 5.49, isOnSale: false },
  },
};
