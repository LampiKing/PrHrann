...
export default defineSchema({
  ...
  prices: defineTable({
    ...
    storeId: v.id("stores"),
    price: v.number(),
    originalPrice: v.optional(v.number()), // Èe je na akciji
    isOnSale: v.boolean(),
  ...
  coupons: defineTable({
    ...
    excludedProducts: v.optional(v.array(v.string())), // Izkljuèeni izdelki (npr. "postreženo meso")
  ...
  couponUsage: defineTable({
    ...
    usedAt: v.number(),
    orderId: v.optional(v.string()), // Za tracking že implementiramo naroèila
  ...
  userProfiles: defineTable({
    ...
    familyOwnerId: v.optional(v.string()), // Èe je èlan family plana
    ...
    lastSavingsReset: v.optional(v.number()), // Kdaj resetiramo meseène
  })
  ...
  emailVerifications: defineTable({
    ...
    lastSentAt: v.optional(v.number()), // zadnji èas pošiljanja emaila
  })
    .index("by_user", ["userId"])
  ...
  shoppingLists: defineTable({
    ...
    updatedAt: v.number(),
    // Family sharing
    sharedWith: v.optional(v.array(v.string())), // userId-ji družinskih èlanov
  ...
  priceAlerts: defineTable({
    userId: v.string(),
    productId: v.id("products"),
    storeId: v.optional(v.id("stores")), // Èe želi spremljati specifièno trgovino
  ...
  purchases: defineTable({
    ...
    storeId: v.id("stores"),
    quantity: v.number(),
    pricePaid: v.number(), // Cena ki jo je plaèal
